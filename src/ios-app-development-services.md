...
bannerdesc: "Welcome to our iOS App Development Services page. We're the experts you need in creating apps for iPhones and iPads. With more than a hundred apps already up and running in the App Store, we know how to make ideas into awesome apps. Our team is here to guide you through every step, from planning to getting your app live. Let's turn your app dreams into reality – explore how we can help make it happen!"
...
servicesList:
  ...
  - count: "01."
    title: "Get Advice for Your iOS App Idea"
    description: "Not sure what features to add to your app? Want help planning how to make your app? Talk to our expert. They'll give you advice on how your app should look, what it should do, and how to make it."

  - count: "02."
    title: "Make Your iPhone App Look Great"
    description: "Do you want your app to look awesome and be easy to use? Our designers can make your app look fantastic. We'll make it so people can use your app without any problems."

  - count: "03."
    title: "Support for iPads and Keeping Your App Working"
    description: "Do you have special things you want in your app? We can help. We make apps for different kinds of Apple devices. We'll also make sure your app keeps working well."

  - count: "04."
    title: "Hire Our Team to Make Your iPhone App"
    description: "Need a group of people to make your app? We've got a team ready to help. You can choose how long you want them to work with you."

  - count: "05."
    title: "Apps for Many Different Devices"
    description: "Do you want your app to work on different phones and computers? We're experts at making apps that work on lots of devices. We can make your app work on iPhones, Android phones, and even Windows computers."

  - count: "06."
    title: "Apps for Big Businesses"
    description: "Do you have a big business and need an app that's safe and works with all your systems? We're here to help you. We'll make a special app just for your business that does what you need."
      ...
      - heading: "Development Tools"
        items:
          - icon: "../../../assets/img/icon-Xcode.svg"
            alt: "Xcode"
            title: "Xcode"
          - icon: "../../../assets/img/icon-ios-sdk.svg"
            alt: "iOS SDK"
            title: "iOS SDK"
          ...
          - icon: "../../../assets/img/icon-objective-c.svg"
            alt: "Objective-C"
            title: "Objective-C"
          - icon: "../../../assets/img/icon-ios-simulator.svg"
            alt: "iOS Simulator"
            title: "iOS Simulator"

      - heading: "User Interface Elements"
        items:
          - icon: "../../../assets/img/icon-uikit.svg"
            alt: "UIKit"
            title: "UIKit"
          - icon: "../../../assets/img/icon-interface-builder.svg"
            alt: "Interface Builder"
            title: "Interface Builder"
          - icon: "../../../assets/img/icon-storyboard.svg"
            alt: "Storyboards"
            title: "Storyboards" 
          - icon: "../../../assets/img/icon-auto-layout.svg"
            alt: "Auto Layout"
            title: "Auto Layout"
      ...
      - heading: "Backend Services"
        items:
          ...
          - icon: "../../../assets/img/icon-vapor.svg"
            alt: "Vapor"
            title: "Vapor"
          - icon: "../../../assets/img/icon-kitura.svg"
            alt: "Kitura"
            title: "Kitura"
          - icon: "../../../assets/img/icon-cloudKit.svg"
            alt: "CloudKit"
            title: "CloudKit" 
          - icon: "../../../assets/img/icon-parse.svg"
            alt: "Parse"
            title: "Parse"  
      ...
      - heading: "Data Management"
        items:
          ...
          - icon: "../../../assets/img/icon-realm.svg"
            alt: "Realm"
            title: "Realm"  
          - icon: "../../../assets/img/icon-user-defaults.svg"
            alt: "UserDefaults"
            title: "UserDefaults"           
      ...
      - heading: "Other Tools"
        items:
          ...
          - icon: "../../../assets/img/icon-git.svg"
            alt: "Git"
            title: "Git"         
          - icon: "../../../assets/img/icon-testflight.svg"
            alt: "TestFlight"
            title: "TestFlight"       
          - icon: "../../../assets/img/icon-firebase-analytics.svg"
            alt: "Firebase Analytics"
            title: "Firebase Analytics"
          - icon: "../../../assets/img/icon-app-center.svg"
            alt: "App Center"
            title: "App Center"
